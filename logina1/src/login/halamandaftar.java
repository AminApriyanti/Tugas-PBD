    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       try{
         ...
         if (tabel.getRowCount()==0){
             JOptionPane.showMessageDialog(rootPane, "masukan data terlebuh dahulu");
             return;
         }
         if (tabel.getSelectedRow()==-1){
             JOptionPane.showMessageDialog(rootPane, "pilihlah data terlebuh dahulu");
             return;
         }
         else{
...
//        String id=tabel.getModel().getValueAt(tabel.getSelectedRow(),0).toString();
        ...
        String klik = (tabel.getModel() .getValueAt(row, 0).toString());
        String sql ="select*from login where id_user='"+klik+"'"; 
        ps = coon.prepareStatement(sql);
        rs = ps.executeQuery();    
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
      ...
      try{
         int row = tabel.getSelectedRow();
         String klik = (tabel.getModel().getValueAt(row, 0).toString());
         String sql = "update login set username=?, password=?, nama=?, Telepon=?, Alamat=?, Status=? where id_user='"+klik+"'";
